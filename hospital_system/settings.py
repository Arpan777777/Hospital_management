...
SECRET_KEY = 'django-insecure-7lare16ew3mij27@6b&fidr*q@!__$5lkw+q(c(0(*eja+p3u6'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Ensure this points to the right folder
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
LOGIN_REDIRECT_URL = '/appointments/patient_list/'
